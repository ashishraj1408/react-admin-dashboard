...
const EvAnalytics = () => {
  ...
  const handleProfileClick = () => {
    console.log('profile are clicked')
    setProfileOpen(!isProfileOpen);
    console.log('profileclick',!isProfileOpen)
  }
  ...
  return (
    <div style={styles.dashboard}>
      ...
      <header style={{ ...styles.header, borderLeft: '2px solid #f5f3f3', position: 'fixed', width: 'calc(100% - 271px)', zIndex: '999' }}>
        <div style={{ width: '50%' }}>
        ...
        <div style={{ ...styles.headerIcons, width: '50%', justifyContent: 'end', margin: '0px', padding: '6px 0px' }}>
          ...
          <IconButton onClick={handleNotificationClick} color="inherit" style={{ background: '#F5F7FA' }}>
            <img
          ...
          <IconButton onClick={handleProfileClick} color="inherit" style={{ background: '#F5F7FA' }}>
            <img
      ...
      {isNotificationOpen && (
       ...
       {
        isProfileOpen && (
          <div style={{ zIndex: 2000, position: 'absolute',   right: '128px', top: '80px',width:'72%' }}>
