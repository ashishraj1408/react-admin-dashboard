...
import LockOpenIcon from '@mui/icons-material/LockOpen'; // You can replace this with your image import

const UnLockPopup = ({ onClose }) => {
  const styles = {
    overlay: {
      position: 'fixed',
      top: 0,
  ...
  return (
    <div style={styles.overlay}>
      <Paper style={styles.popupContainer}>
        ...
        />
        <LockOpenIcon style={{...styles.lockIcon, color:'green'}} />
        <h2 style={styles.title}>Unlock Confirmation!</h2>
        <p style={{...styles.content, fontFamily:'Inter', fontWeight:'500', fontSize:'15px'}}>
          You are about to Unlock the <br />device id #1234567890 remotely.
        </p>
        <p style={{fontFamily:'Inter', fontWeight:'500', fontSize:'15px'}}>Are you sure you wish to proceed to Unlock?</p>
